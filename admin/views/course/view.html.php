 ...
 * Course View
 */
class OSBITViewCourse extends JViewLegacy
{
	/**
	 * display method of course view
	 * @return void
	 */
	...
	protected function setDocument() 
	{
		...
		$document->setTitle($isNew ? JText::_('COM_OSBIT_COURSE_CREATING') : JText::_('COM_OSBIT_COURSE_EDITING'));
		$document->addScript(JURI::root() . $this->script);
		$document->addScript(JURI::root() . "/administrator/components/com_osbit/views/course/submitbutton.js");
		JText::script('COM_OSBIT_COURSE_ERROR_UNACCEPTABLE');
	}
}
